...
namespace WiM.Resources.Hypermedia
{
    public class Link
    {
        #region Properties
    ...
    public abstract class HypermediaEntity : System.Data.Objects.DataClasses.EntityObject
    {
        ...
        virtual public void LoadLinks(string baseURI, linkType ltype = linkType.e_group)
        {
            switch (ltype)
            {
        ...
        virtual public void LoadLinks(string baseURI, List<Link> hypermedia)
        {
            this._links = hypermedia;
            this.LoadLinks(baseURI, linkType.e_individual);
        }
        #endregion
